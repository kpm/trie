h1. Fork: rename to FastTrie

This fork renames the class to reflect the name of the gem.  i.e., use require 'FastTrie' instead of require 'Trie'.  Otherwise having both the fast_trie and trie gems installed will make one of them unavailable.  
